...
void GRIP_Partitioning_withAAT(CompRow_Mat_double &AAT, idx_t nParts, idx_t* part, double imb)
{
   ...
   // eliminate zero and diagonal values then fill tmp_val
     ...
     cout << "Launching METIS " << " Vwgt: " << metis_vwght <<  " Ewgt: " << metis_ewght  <<" UFAC: " << imb * 1000  << "seed " << options[METIS_OPTION_SEED] << " Recursive: " << metis_recursive << " part: " << nParts << " nVertices "<< nVertices << " nEdges " << xadj[nVertices] << endl;
